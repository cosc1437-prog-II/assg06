...
${OBJ_DIR}/assg06-library.o: ${SRC_DIR}/assg06-library.cpp ${INC_DIR}/assg06-library.hpp
${OBJ_DIR}/${PROJECT_NAME}-tests.o: ${SRC_DIR}/${PROJECT_NAME}-tests.cpp ${INC_DIR}/assg06-library.hpp
